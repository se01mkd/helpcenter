...
class Mkd_Helpcenter_Block_Adminhtml_Helpcenter_Switcher extends Mage_Adminhtml_Block_Template
{
    protected function _prepareLayout()
    {
        $this->setTemplate('helpcenter/switcher.phtml');
    ...
    public function getStoreSelectOptions()
    {
        ...
        $options['default'] = array(
            ...
            'url'      => $url->getUrl('*/*/*', array('id'=>$paramID,'section'=>$section)),
                ...
                foreach ($storeModel->getStoreCollection() as $store) {
                    ...
                    if (!$websiteShow) {
                        ...
                        $options['website_' . $website->getID()] = array(
                            ...
                            'url'      => $url->getUrl('*/*/*', array('id'=>$paramID,'section'=>$section, 'website'=>$website->getID())),
                    ...
                    $options['store_' . $store->getCode()] = array(
                        'label'    => $store->getName(),
                        'url'      => $url->getUrl('*/*/*', array('id'=>$paramID,'section'=>$section, 'website'=>$website->getID(), 'store'=>$store->getID())),
